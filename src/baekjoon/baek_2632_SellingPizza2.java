...
public class baek_2632_SellingPizza {
	public static void main(String[] args) {
		...
		subSumA.add(0);			subSumB.add(0);			// 피자 조각 선택 X
		subSumA.add(sizeA);		subSumB.add(sizeB);		// 전체 피자 조각 선택
		
		getSubSum(A, subSumA);		// 1~(전체피자조각-1) 조각의 부분합
		getSubSum(B, subSumB);
	...
	public static void getSubSum(int[] pizza, ArrayList<Integer> subSum) {
